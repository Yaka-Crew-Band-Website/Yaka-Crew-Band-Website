...
$stmt = $pdo->query("SELECT * FROM tshirts");
$tshirts = $stmt->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <meta charset="UTF-8" />
  <title>Band T‑Shirts | YAKA Crew</title>
...
document.addEventListener('DOMContentLoaded', updateMerchCartCount);
  ...
  <?php foreach ($tshirts as $row): ?>
      ...
      <a href="YCMerch-product.php?id=<?= htmlspecialchars($row['id']) ?>">
